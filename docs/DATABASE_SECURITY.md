...
immutable documents and delivery evidence receive no runtime UPDATE or DELETE.
Existing trigger and lifecycle protections remain authoritative where a record
is conditionally immutable.
