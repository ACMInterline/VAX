...
export const englishPublicSiteCopy = {
  ...
  requestForm: {
    ...
    fields: {
      ...
      servicesHint:
        "Choose every service that may be relevant. Final scope is confirmed after assessment.",
      serviceOptions: {
        carpet: "Carpet",
        rug: "Rug",
        sofa: "Sofa",
        ...
        "other-upholstery": "Other upholstery",
      },
      ...
      conditionOptions: {
        ...
        "visible-soil": "Visible soil or traffic marks",
        "heavy-soil": "Heavy soil or multiple concerns",
        unsure: "Not sure",
      },
