...
export default function CustomerCrmError({
  reset,
}: {
  ...
  return (
    <section className="crm-route-state crm-route-state--error" role="alert">
      <div className="crm-route-state__copy crm-route-state__copy--bg" lang="bg">
        <p className="eyebrow">Клиентски регистър</p>
        <h1>Клиентските данни не можаха да се заредят</h1>
      ...
      <div className="crm-route-state__copy crm-route-state__copy--en" lang="en">
        <p className="eyebrow">Customer registry</p>
        <h1>Customer records could not be loaded</h1>
